...
CREATE TABLE tbl_author_document_mapping (
 ...
 -- adding these index will optimize insertion and any query
ALTER TABLE tbl_people ADD UNIQUE INDEX name_UNIQUE (name ASC);
ALTER TABLE tbl_genres ADD UNIQUE INDEX genreUnique_UNIQUE (genre_name ASC);
